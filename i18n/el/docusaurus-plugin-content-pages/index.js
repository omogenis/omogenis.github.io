            ...
            <div>
              <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                <div className="relative overflow-hidden rounded-full py-1.5 px-4 text-sm leading-6 ring-1 ring-white">
                  ...
                  Наш сайт доступен на русском языке {" "}
                    <a
                      href="/"
                      className="font-semibold text-white hover:text-white"
                    >
                      <span className="absolute inset-0" aria-hidden="true" />
                      Открыть! <span aria-hidden="true">&rarr;</span>
                    </a>
                  </span>
                </div>
              </div>
      ...
      <div class="container px-6 py-10 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
          ...
          <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
            ...
            <p class="text-gray-300">
            Οδηγίες για τον τρόπο προετοιμασίας ενός πακέτου εγγράφων, επαφές μεταφραστών, πηγές για την ελληνική και ελληνιστική ιστορία (στα ρωσικά).
            </p>
...
export default function Home() {
  ...
  return (
    <Layout
      title={`Έλληνες από την πρώην Σοβιετική Ένωση`}
      description="Εκμάθηση ελληνικών, απόκτηση ιθαγένειας και χρήσιμες συμβουλές"
    >
      <Header />
      <Materials />
