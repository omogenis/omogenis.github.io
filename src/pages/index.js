    ...
    <section className="bg-gray-900">
      <div className="container px-6 py-10 mx-auto">
        <h2 className="text-3xl font-semibold lg:text-4xl text-white">
          ...
          <span className="underline decoration-blue-500">материалами</span>
        </h2>
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
          <div className="p-8 space-y-3 border-2 border-blue-300 rounded-xl">
            ...
            <h3 className="text-2xl font-semibold text-white">Материалы для подготовки к собеседованию</h3>
          ...
          <div className="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl tw-border-solid">
            <span className="inline-block text-blue-500 dark:text-blue-400">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-8 h-8"
            ...
            <h3 className="text-2xl font-semibold text-white">Разговорный клуб</h3>
