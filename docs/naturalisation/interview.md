...
:::info Школа греческого языка Greek it Easy: курсы подготовки к собеседованию
...
<div className="mt-8 flex gap-x-4 sm:justify-right">
  <a className="button button--primary button--lg no-underline" href="https://greek-it-easy.tilda.ws/"> Сайт школы </a>
  <a className="button button--primary button--lg" href="https://t.me/greek_it_easy"> Телеграм школы </a>
</div>
